...
| Алгоритм   | Среднее еды | Стандартное отклонение | Средняя награда | Стандартное отклонение |
|------------|-------------|------------------------|-----------------|------------------------|
...
**Выводы:**
- Все три алгоритма успешно обучаются находить еду и избегать столкновений
- DQN и SARSA показывают сопоставимые результаты
